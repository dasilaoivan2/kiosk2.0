...
@section('content')
    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2"> Date Range (Clients)

            </h1>


            {!! Form::open(['route' => 'admin.prints.range.search', 'class' => 'form-inline']) !!}

            <div class="form-group mb-2">
                {!! Form::label('datefrom', 'Date From') !!}
                {!! Form::date('datefrom',null,['class'=>'form-control','placeholder'=>'Type here...','autofocus','required']) !!}
            </div>

            <div class="form-group mb-2">
                {!! Form::label('dateto', 'Date To') !!}
                {!! Form::date('dateto',null,['class'=>'form-control','placeholder'=>'Type here...','autofocus','required']) !!}
            </div>
